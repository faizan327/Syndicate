...
class SignupScreen extends StatefulWidget {
  ...
  final bool isAdminCreatingUser; // New parameter
  const SignupScreen(this.show, {super.key, this.isAdminCreatingUser = false});
...
class _SignupScreenState extends State<SignupScreen> {
  ...
  final bio = TextEditingController(text: "Modifier votre bio");
